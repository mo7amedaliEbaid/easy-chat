...
class Addmembersingroupscreen extends StatefulWidget {
  final String groupChatId, name;
  final List membersList;

  const Addmembersingroupscreen(
      {required this.name,
  ...
  @override
  _AddmembersingroupscreenState createState() =>
      _AddmembersingroupscreenState();
}

class _AddmembersingroupscreenState extends State<Addmembersingroupscreen> {
